...
public class XTemplate extends HashMap<String, String>{
    ...
    private void _apply(XWPFParagraph par){
        ...
        while( m.find() ){
            ...
            TextSegement seg = par.searchText(key, pos );
    ...
    //============  Setters e Getters  =================
    public XTemplate docx(XWPFDocument docx){ this.docx = docx; return this; }
    public XWPFDocument docx(){ return this.docx; }
    
    public XTemplate regexFlags(int flags){ this.regexFlags = flags; return this; }
